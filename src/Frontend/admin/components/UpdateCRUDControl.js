...
const Updates = () => {
    ...
    return ( <
        ...
        component = "h2" > { isEditing ? 'Edit Notification' : 'Add Notification' } <
        /Typography> <
        Button variant = "contained"
        startIcon = { < CloseIcon / > }
        onClick = {
        ...
        Box sx = {
            { mb: 2 } } >
        <
        TextField fullWidth label = "Notification Title"
        name = "title"
        ...
        Box sx = {
            { mb: 2 } } >
        <
        TextField fullWidth label = "External Text For Links"
        name = "external_text"
        ...
        Box sx = {
            { mb: 2 } } >
        <
        TextField fullWidth label = "External Link"
        name = "external_link"
        ...
        color = "primary"
        onClick = { handleSubmit } > { isEditing ? 'Update Notification' : 'Add Notification' } <
        /Button> <
        /Box> <
        Box sx = {
            { mb: 2 } } >
        ...
        /Typography> {
            loading ? ( <
                div style = {
                    { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', fontSize: '2em' } } >
                <
                ...
                div > {
                    events.length ? ( <
                        ...
                        Typography variant = "h6" > No Notifications Added(or) Server is Busy
                        while Loading the Notifications < /Typography>
                    )
                } <
                /div>
            )
