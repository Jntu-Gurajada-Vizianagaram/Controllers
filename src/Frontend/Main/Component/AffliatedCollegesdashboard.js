...
export default function Affliatedcollegedashboard() {
...
open={open}>
  ...
  <ListItem disablePadding>
    <ListItemButton className='listview' component={RouterLink} to='affiliated-college'>
    <ListItemText primary={<span style={{ fontSize: '23px' }}>Affiliated Colleges</span>} />
    </ListItemButton>
  </ListItem>
  <ListItem disablePadding>
    <ListItemButton className='listview' component={RouterLink} to='add-new-affliated-college'>
      <ListItemText primary={<span style={{ fontSize: '23px' }}>Add College</span>} />
    </ListItemButton>
  </ListItem>
  <ListItem disablePadding>
