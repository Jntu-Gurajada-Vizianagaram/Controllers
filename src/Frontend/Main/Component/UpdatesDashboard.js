...
open={open}>
  ...
  <ListItem disablePadding>
    <ListItemButton className='listview' component={RouterLink} to='updates'>
    <ListItemText primary={<span style={{ fontSize: '23px' }}>All Notifications</span>} />
    </ListItemButton>
  </ListItem>
  <ListItem disablePadding>
    <ListItemButton className='listview' component={RouterLink} to='updates'>
      <ListItemText primary={<span style={{ fontSize: '23px' }}>Add Notification</span>} />
    </ListItemButton>
  </ListItem>
  <ListItem disablePadding>
