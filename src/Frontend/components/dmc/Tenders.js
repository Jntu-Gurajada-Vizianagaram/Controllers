...
import '../../css/dmc_css/Dmc_tenders.css';
...
const Tenders = () => {
    ...
    const ALLOWED_FILE_FORMATS = ['image/jpeg', 'image/png', 'image/jpg', 'application/pdf']; 
    ...
    const handleSubmit = async(e) => {
      ...
      if (formData.uploadedImage) {
        try {
          ...
          await axios.post('http://localhost:3001/Trades', formDataToSend, {
            headers: {
  ...
  return (
    <div>
      <div className="title">Upload Tenders</div>
